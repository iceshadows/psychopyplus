...
We will try to give as much support as possible for free in the public space. However if you are still stuck we can offer paid consultancy options to help debug. You can contact our team directly  at consultancy@wearlab.tech. Consultancy is part of our sustainable model for Open Source Tools and allows us to keep creating free and accessible tools (see :ref:`overview` and read more on `Open Science Tools <https://wearlab.tech/>`_). Our Science team will be happy to help via one-to-one technical support hours or larger consultancy projects.